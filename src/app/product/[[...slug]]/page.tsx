      ...
      <div className="grid grid-cols-4 mt-5 place-items-center">
        ...
        {products.data.length > 0 &&
          products.data.map((products: any) => (
            <div key={products.id} className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow my-5 dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                <img className="p-8 rounded-t-lg object-cover h-96 w-full" src={products.image} alt="product image" />
              </a>
              <div className="px-5 pb-5">
                <a href="#">
                  <h5 className="text-xl font-semibold tracking-tight text-gray-900 truncate dark:text-white">{products.title}</h5>
                </a>
